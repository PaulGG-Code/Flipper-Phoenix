...
const UART_TerminalItem items[NUM_MENU_ITEMS] = {
    ...
    {"Quick message",
     {"SOS", "CQD", "VVV", "Eureka", "E.T ph...", "what h...", "Phoenix", "Flipper"},
     8,
     {"sos", "cqd", "vvv", "eureka", "e.t. phone home", "what hath god wrought!", "let the phoenix begin", "flipper zero in da housa"},
     NO_ARGS,
     FOCUS_CONSOLE_END,
     NO_TIP},
